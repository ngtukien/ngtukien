...
export const viData = {
  ...
  objective: "Là sinh viên năm 4 định hướng theo Devops Engineer, em mong muốn được tham gia vào môi trường chuyên nghiệp để học hỏi và thực hành các kỹ năng triển khai hệ thống như CI/CD, Docker, Kubernetes và tự động hóa vận hành bằng Ansible. Em đặt mục tiêu phát triển nền tảng về Cloud và Infrastructure, nâng cao khả năng làm việc với pipeline, monitoring và tối ưu quy trình triển khai, từ đó trở thành DevOps Engineer vững kỹ thuật trong tương lai.",
  education: [
    {
      id: 1,
