...
export const enData = {
  ...
  objective: "As a 4th-year student aspiring to become a Cloud Engineer, I am eager to join a professional environment to learn and practice skills in designing, deploying, and operating cloud infrastructure (AWS, Azure, Google Cloud). I aim to build a strong foundation in Cloud Native architecture, optimize performance and costs, and ensure system security, thereby becoming a technically solid Cloud Engineer in the future.",
  education: [
    {
      id: 1,
